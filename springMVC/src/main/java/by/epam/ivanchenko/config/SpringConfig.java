...
@EnableJpaRepositories("by.epam.ivanchenko.repository")             // Руть к репозиториям
...
//        sessionFactory.setPackagesToScan("by.epam.ivanchenko.model");           // Указываем из какого пакета сканировать сущности
